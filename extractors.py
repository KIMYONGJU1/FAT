            ...
            for page in pdf.pages:
                ...
                for line_words in lines:
                    ...
                    if match:
                        ...
                        # to the LEFT of the circuit code (GSP layout places Circuit Name
                        # before Circuit No.) and fall back to the right side only when the
                        # left side is empty (for atypical layouts).
                        ...
                        if name_col is not None:
                            ...
                            name_words = left_words if left_words else right_words
                            if name_words:
